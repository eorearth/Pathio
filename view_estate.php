...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h4 class="card-title">หมายเลขหอพัก: <b><?= isset($code) ? $code : "" ?></b></h4>
        </div>
        <div class="card-body">
            <div class="row gx-4 gx-lg-5 align-items-top">
                ...
                <div class="col-md-6">
                    ...
                    <fieldset>
                        <legend class="h4 text-muted">รายละเอียด</legend>
                        <div class="row">
                            <div class="col-6">
                                <span class="text-muted">ประเภทหอพัก: </span><?= isset($type) ? $type : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">หอพักรวม/หญิง: </span><?= isset($purpose) ? $purpose : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">ขนาดห้องพัก: </span><?= isset($area) ? $area : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">ราคาต่อเดือน: </span><?= isset($sale_price) ? format_num($sale_price) : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">ที่อยู่หอพัก: </span><?= isset($location) ? $location : '' ?>
                            </div>
                            <div class="col-6">
                                <span class="text-muted">Status: </span> 
                                <?php if(isset($status) && $status == 1): ?>
                                    <span class="badge badge-success px-3 rounded-pill">ว่าง</span>
                                <?php else: ?>
                                    <span class="badge badge-danger px-3 rounded-pill">ไม่ว่าง</span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        <legend class="h4 text-muted">สิ่งอำนวยความสะดวก</legend>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="card card-outline card-info rounded-0 shadow">
                        <div class="card-header">
                            <h4 class="cart-title"><b>เจ้าของหอพัก/นายหน้า:</b></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
