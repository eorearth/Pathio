...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Amenity permanently?","delete_amenity",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Add New Amenity","amenities/manage_amenity.php")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Update Amenity Details","amenities/manage_amenity.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
