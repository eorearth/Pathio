...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		<h3 class="card-title">จำนวนหอพัก</h3>
		<div class="card-tools">
			<a href="?page=real_estate/manage_estate" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>เพิ่มหอพัก</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
								  	<a class="dropdown-item" href="?page=real_estate/view_estate&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> ดู</a>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item" href="?page=real_estate/manage_estate&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> แก้ไข</a>
				                    <div class="dropdown-divider"></div>
