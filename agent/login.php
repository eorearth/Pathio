    ...
    <div class="card-body">
      ...
      <form id="login-agent-form" action="" method="post">
        ...
        <div class="row align-items-end">
          <div class="col-8">
            <a href="<?php echo base_url ?>">กลับไปที่หน้าเว็ป</a>
          </div>
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block btn-sm btn-flat">ลงชื่อเข้าใช้</button>
          </div>
          <!-- /.col -->
          <div class="col-12 text-center">
            <a href="<?php echo base_url ?>agent/registration.php">สร้างบัญชี</a>
          </div>
        </div>
      </form>
      <!-- /.social-auth-links -->
